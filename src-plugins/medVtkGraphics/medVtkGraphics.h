...
/**
 * @class medVtkGraphics
 * @brief Concrete implementation of a medAbstractView using vtkinria3d's vtkImageView system.
 * medVtkGraphics stands for vtkinria3dView. It embeds in a QVTKWidget a visualization system for 2D
 * and 3D images.
...
class MEDVTKGRAPHICSPLUGIN_EXPORT medVtkGraphics : public medAbstractView, public medAbstractViewCoordinates
{
    Q_OBJECT
...
public:
    ...
    // access method to internal members for medVtkGraphics**Interactor classes
