...
//                linear_algebra_sparse_settings.endGroup();
        ...
        medProcessLayer::gcStremMsLesionsSegmentation::initialize(realpath);
    }
}
...
namespace gcStremMsLesionsSegmentation
{
    namespace _private
    {
        medAbstractGcStremMsLesionsSegmentationProcessPluginManager manager;
        medAbstractGcStremMsLesionsSegmentationProcessPluginFactory factory;
    }

    medAbstractGcStremMsLesionsSegmentationProcessPluginManager& pluginManager(void)
    {
        return _private::manager;
    }

    medAbstractGcStremMsLesionsSegmentationProcessPluginFactory& pluginFactory(void)
    {
        return _private::factory;
    }
